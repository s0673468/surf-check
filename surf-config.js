...
const UI = {
  pt: {
    ...
    fetched: (time) => `Dados baixados às ${time}`,
    fetchTimeHelp: "Horário em que este navegador baixou os dados; não é o horário de emissão do modelo.",
    unavailable: "Previsão indisponível",
    partial: (n, m) => `${n}/${m} praias atualizadas`,
    partialDetails: (names) => `Previsão parcial. Sem dados agora: ${names || "algumas praias"}.`,
    regionalTemps: "Temperaturas",
    regionalTempsAt: (time) => `Média regional · ${time}`,
    ...
    recommendationsAria: "Melhores praias no horário selecionado",
    mapAria: "Mapa das praias e pontuações",
    showMap: "Mostrar mapa",
    hideMap: "Ocultar mapa",
    activateMapZoom: "Ativar zoom com a rolagem",
    mapZoomActive: "Zoom com a rolagem ativado",
    radarLoading: "Carregando radar de chuva",
    radarUnavailable: "Radar de chuva indisponível; as pontuações continuam válidas.",
    radarNoMatch: "Sem imagem de radar próxima deste horário.",
    radarAt: (time) => `Radar de chuva das ${time}`,
    mapFallback: "Mapa simplificado; radar indisponível.",
    mapMarkerEmpty: (name) => `${name}: sem pontuação neste horário`,
    mapMarker: (name, score, label, selected) =>
      `${name}: ${score}, ${label}${selected ? ", praia selecionada" : ""}`,
    today: "Hoje",
    now: "Agora",
    daySummary: "Resumo do dia",
    dayPeakScope: (name, time) => `Pico do dia: ${name}, ${time}`,
    bestBets: "Melhores opções",
    topPickAt: (label, time) => `Melhor às ${time} · ${label}`,
    selectedHourScope: (time) => `Horário selecionado · ${time}`,
    topGroup: (names) => `Grupo da frente, quase empatado: ${names}`,
    supportDriver: (factor) => `Ajuda: ${factor}`,
    watchDriver: (factor) => `Atenção: ${factor}`,
    showAllBeaches: (count) => `Ver todas as ${count} praias`,
    showFewer: "Mostrar só as três primeiras",
    selectedSpot: "Praia selecionada",
    selectedSpotAt: (time) => `Praia selecionada · ${time}`,
    saveFavorite: (name) => `Salvar ${name} como praia favorita`,
    removeFavorite: (name) => `Remover ${name} das favoritas`,
    downloadTruth: (name) => `Baixar modelo de observação para ${name}`,
    downloadTruthHelp: "Baixa o forecast exato e os metadados; preencha a observação real depois da sessão.",
    truthDownloaded: (name) => `Modelo de observação de ${name} baixado`,
    swell: "Swell",
    wind: "Vento",
    tide: "Maré",
    mslReading: (value) => `leitura MSL ${value} m`,
    weather: "Tempo",
    toneWord: (tone) =>
  ...
  en: {
    ...
    fetched: (time) => `Data fetched ${time}`,
    fetchTimeHelp: "When this browser fetched the data; this is not the model issue time.",
    unavailable: "Forecast unavailable",
    partial: (n, m) => `${n}/${m} beaches updated`,
    partialDetails: (names) => `Partial forecast. No data right now: ${names || "some beaches"}.`,
    regionalTemps: "Regional temps",
    regionalTempsAt: (time) => `Regional average · ${time}`,
    ...
    recommendationsAria: "Best beaches at the selected hour",
    mapAria: "Map of beaches and scores",
    showMap: "Show map",
    hideMap: "Hide map",
    activateMapZoom: "Enable scroll zoom",
    mapZoomActive: "Scroll zoom enabled",
    radarLoading: "Loading rain radar",
    radarUnavailable: "Rain radar unavailable; surf scores are still available.",
    radarNoMatch: "No radar image close to this forecast hour.",
    radarAt: (time) => `Rain radar at ${time}`,
    mapFallback: "Simplified map; radar unavailable.",
    mapMarkerEmpty: (name) => `${name}: no score at this hour`,
    mapMarker: (name, score, label, selected) =>
      `${name}: ${score}, ${label}${selected ? ", selected beach" : ""}`,
    today: "Today",
    now: "Now",
    daySummary: "The day at a glance",
    dayPeakScope: (name, time) => `Day peak: ${name}, ${time}`,
    bestBets: "Best bets",
    topPickAt: (label, time) => `Best at ${time} · ${label}`,
    selectedHourScope: (time) => `Selected hour · ${time}`,
    topGroup: (names) => `Near-tied top group: ${names}`,
    supportDriver: (factor) => `Helps: ${factor}`,
    watchDriver: (factor) => `Watch: ${factor}`,
    showAllBeaches: (count) => `See all ${count} beaches`,
    showFewer: "Show the top three only",
    selectedSpot: "Selected spot",
    selectedSpotAt: (time) => `Selected spot · ${time}`,
    saveFavorite: (name) => `Save ${name} as favorite beach`,
    removeFavorite: (name) => `Remove ${name} from favorites`,
    downloadTruth: (name) => `Download observation template for ${name}`,
    downloadTruthHelp: "Downloads the exact forecast and metadata; fill in the real observation after the session.",
    truthDownloaded: (name) => `${name} observation template downloaded`,
    swell: "Swell",
    wind: "Wind",
    tide: "Tide",
    mslReading: (value) => `MSL reading ${value} m`,
    weather: "Weather",
    toneWord: (tone) =>
